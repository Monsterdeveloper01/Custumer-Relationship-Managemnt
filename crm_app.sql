...
--
-- Host: localhost:3306
-- Generation Time: Aug 28, 2025 at 10:27 AM
...
CREATE TABLE `crm` (
  ...
  `contact_person_email` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `phone_wa` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `company_industry_type` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
